...
/**
 * <p>
 * Since 2.7.0+, export and refer will only be executed when Spring is fully initialized,
 * and each Config bean will get refreshed on the start of the export and refer process.
 * So it's ok for this bean not to be the first Dubbo Config bean being initialized.
 * </p>
 *
 * If use ConfigCenterConfig directly, you should make sure ConfigCenterConfig.init()
 * is called before actually export/refer any Dubbo service.
 */
